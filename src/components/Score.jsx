...
function Score() {
  return (
    <div id='scoreWrapper' className='w-full max-w-[375px] bg-gradient-to-b from-gradientOneFirst from-0% via-gradientOneSecond via-0.01% to-gradientOneThird to-100% shadow-[0_30px_60px_rgba(61,108,236,0.15)] rounded-[0_0_32px_32px] mb-6 md:mb-0 md:max-w-[368px] md:h-[512px]'>
