...
function Score() {
  return (
    <div id='scoreWrapper' className='bg-gradient-to-b from-gradientOneFirst from-0% via-gradientOneSecond via-0.01% to-gradientOneThird to-100% shadow-[0_30px_60px_rgba(61,108,236,0.15)] rounded-[0_0_32px_32px]'>
